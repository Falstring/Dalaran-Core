...
Position const GalakLoc = { -4887.8f, -1374.1f, -52.86f, 0.0f };
Position const Galak2Loc = { -4891.6f, -1378.32f, -53.17f, 0.0f };
Position const Galak3Loc = { -4895.3f, -1381.75f, -53.10f, 0.0f };
    ...
    public:
        ...
        struct npc_kanatiAI : public npc_escortAI
        {
            ...
            void DoSpawnGalak()
            {
                ...
                me->SummonCreature(NPC_GALAK_ASS, Galak2Loc, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
                me->SummonCreature(NPC_GALAK_ASS, Galak3Loc, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
            }

    ...
    struct npc_twiggy_flatheadAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            if (EventInProgress)
            {
                ...
                if (me->GetDistance2d(warrior) >= 80.0f)
                {                    
...
#define GOSSIP_ITEM_DEATHGATE   "Let's start the attack!"
    ...
    struct npc_deathgateAI : public ScriptedAI
    {
        ...
        void DoAction(int32 action) override
        {
            if (action == ACTION_START_BARRENS)
                events.ScheduleEvent(EVENT_START, 2 * IN_MILLISECONDS);
        }
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (player->GetQuestStatus(QUEST_COUNTERATTACK) == QUEST_STATUS_INCOMPLETE)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_DEATHGATE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 0);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
            case EVENT_START:
                events.ScheduleEvent(EVENT_SPAWN_ONE, 2 * IN_MILLISECONDS);
                break;
            case EVENT_SPAWN_ONE: // ugly, move to creature_summons
                me->SummonCreature(NPC_DEFENDER, -280.703f, -1908.01f, 91.6668f, 1.77351f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_DEFENDER, -286.384f, -1910.99f, 91.6668f, 1.59444f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_DEFENDER, -297.373f, -1917.11f, 91.6746f, 1.81435f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_AXE_THROWER, -293.212f, -1912.51f, 91.6673f, 1.42794f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -280.037f, -1888.35f, 92.2549f, 2.28087f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -292.107f, -1899.54f, 91.667f, 4.78158f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -305.57f, -1869.88f, 92.7754f, 2.45131f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -289.972f, -1882.76f, 92.5714f, 3.43148f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -277.454f, -1873.39f, 92.7773f, 4.75724f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -271.581f, -1873.39f, 92.7773f, 4.75724f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -269.982f, -1828.6f, 92.4754f, 4.68655f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -269.982f, -1828.6f, 92.4754f, 4.68655f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -279.267f, -1827.92f, 92.3128f, 1.35332f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -297.42f, -1847.41f, 93.2295f, 5.80967f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -310.607f, -1831.89f, 95.9363f, 0.371571f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -329.177f, -1842.43f, 95.3891f, 0.516085f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -324.448f, -1860.63f, 94.3221f, 4.97793f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -324.448f, -1860.63f, 94.3221f, 4.97793f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_SPAWN_TWO, 20 * IN_MILLISECONDS);
                break;
            case EVENT_SPAWN_TWO:
                me->SummonCreature(NPC_INVADER, -290.588f, -1858.11f, 92.5026f, 4.14698f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -304.978f, -1844.7f, 94.4432f, 1.61721f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -297.089f, -1867.68f, 92.5601f, 2.21804f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -286.103f, -1846.18f, 92.544f, 6.11047f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -308.105f, -1859.08f, 93.8039f, 2.80709f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                me->SummonCreature(NPC_STORMSEER, -286.988f, -1876.47f, 92.7447f, 1.39494f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 450 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_SPAWN_THREE, 10 * IN_MILLISECONDS);
                break;
            case EVENT_SPAWN_THREE:
                me->SummonCreature(NPC_INVADER, -291.86f, -1893.04f, 92.0213f, 1.96121f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -298.297f, -1846.85f, 93.3672f, 4.97792f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -294.942f, -1845.88f, 93.0999f, 4.86797f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_INVADER, -294.942f, -1845.88f, 93.0999f, 4.86797f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                me->SummonCreature(NPC_WARLORD, -296.718f, -1846.38f, 93.2334f, 5.02897f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 250 * IN_MILLISECONDS);
                break;
            default:
                break;
            }

...
enum PaladinSpells
{
    ...
    SPELL_PALADIN_ICON_RIGHTEOUS_VENGEANCE       = 3025,
    SPELL_PALADIN_SEAL_OF_COMMAND                = 20375,
    SPELL_PALADIN_SEAL_OF_COMMAND_TRIGGERED      = 20424
};
...
public:
    ...
    class spell_pal_seal_of_command_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo& eventInfo)
        {
            if (const SpellInfo* procSpell = eventInfo.GetDamageInfo()->GetSpellInfo())
                if (procSpell->SpellIconID == SPELL_PALADIN_ICON_RIGHTEOUS_VENGEANCE)
                    return false;
            return true;
        }
        ...
        void Register()
        {
            if (m_scriptSpellId == SPELL_PALADIN_SEAL_OF_COMMAND)
            {
    ...
    class spell_pal_seal_of_command_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            if (m_scriptSpellId == SPELL_PALADIN_SEAL_OF_COMMAND_TRIGGERED)

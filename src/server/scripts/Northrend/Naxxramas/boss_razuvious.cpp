	...
	struct boss_razuviousAI : public BossAI
	{
		...
		void KilledUnit(Unit* who)
		{
			...
			if (!urand(0, 3))
			{
				...
				me->Yell("You should've stayed home!", LANG_UNIVERSAL, 0);
			}
		}
		...
		void JustDied(Unit* killer)
		{
			...
			me->Yell("An honorable... death...", LANG_UNIVERSAL, 0);
		...
		void EnterCombat(Unit *who)
		{
			...
			case 0:
				...
				me->Yell("Hah hah, I'm just getting warmed up!", LANG_UNIVERSAL, 0);
				break;
			case 1:
				DoPlaySoundToSet(me, SOUND_AGGRO_2);
				me->Yell("Stand and fight!", LANG_UNIVERSAL, 0);
				break;
			case 2:
				DoPlaySoundToSet(me, SOUND_AGGRO_3);
				me->Yell("Show me what you've got!", LANG_UNIVERSAL, 0);
				break;
			}
		...
		void UpdateAI(uint32 diff)
		{
			...
			case EVENT_SPELL_UNBALANCING_STRIKE:
				...
				events.RescheduleEvent(EVENT_SPELL_UNBALANCING_STRIKE, 30000);
				break;
			...
			case EVENT_SPELL_JAGGED_KNIFE:
				...
				events.ScheduleEvent(EVENT_SPELL_JAGGED_KNIFE, 25000);
				break;
			case EVENT_PLAY_COMMAND:
				...
				case 0:
					...
					me->Yell("Do as I taught you!", LANG_UNIVERSAL, 0);
					break;
				case 1:
					DoPlaySoundToSet(me, SOUND_COMMAND_2);
					me->Yell("Show them no mercy!", LANG_UNIVERSAL, 0);
					break;
				case 2:
					DoPlaySoundToSet(me, SOUND_COMMAND_3);
					me->Yell("You disappoint me, students!", LANG_UNIVERSAL, 0);
					break;
				}
				events.ScheduleEvent(EVENT_PLAY_COMMAND, 40000);
				break;
	...
	struct boss_razuvious_minionAI : public ScriptedAI
	{
		...
		void UpdateAI(uint32 diff)
		{
			...
			case EVENT_MINION_BLOOD_STRIKE:
				...
				events.ScheduleEvent(EVENT_MINION_BLOOD_STRIKE, 8000);
				break;
			case EVENT_MINION_BONE_BARRIER:
				me->CastSpell(me, SPELL_BONE_BARRIER, true);
				events.ScheduleEvent(EVENT_MINION_BONE_BARRIER, 40000);
				break;
			}

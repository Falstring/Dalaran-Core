...
enum eData
{
	...
	DATA_BLACK_KNIGHT,
	DATA_KNIGHT,
	DATA_PHASE1_GRANDCHAMPIONS_DONE,
	DATA_RESET_INTRO_EVENT,
	DATA_WIPE_CONTROL_CHAMPIONS_LAST_PHASE,
	DATA_RESET_GRANDCHAMPIONS_DEATHS,
	DATA_CHAMPIONS_DEATHS,
	DATA_GRAND_CHAMPIONS_STARTED,
	DATA_CLOSE_DOOR
};
...
enum eVehicles
{
	...
	//Faction Champions (ALLIANCE)
	VEHICLE_DARNASSIA_NIGHTSABER = 80004,
	VEHICLE_EXODAR_ELEKK = 80003,
	VEHICLE_STORMWIND_STEED = 80000,
	VEHICLE_GNOMEREGAN_MECHANOSTRIDER = 80002,
	VEHICLE_IRONFORGE_RAM = 80001,
	...
	//Faction Champions (HORDE)
	VEHICLE_FORSAKE_WARHORSE = 80009,
	VEHICLE_THUNDER_BLUFF_KODO = 80007,
	VEHICLE_ORGRIMMAR_WOLF = 80005,
	VEHICLE_SILVERMOON_HAWKSTRIDER = 80008,
	VEHICLE_DARKSPEAR_RAPTOR = 80006,

...
public:
	...
	struct boss_anub_arakAI : public BossAI
	{
		...
		void DisableRotate(bool apply)
		{
			...
			else if (!me->HasUnitState(UNIT_STATE_POSSESSED))
		...
		void UpdateAI(uint32 diff)
		{
			...
			case EVENT_SUMMON_ASSASSINS:
				SummonHelpers(531.32f, 247.42f, 223.48f, SPELL_SUMMON_ASSASSIN);
				SummonHelpers(570.51f, 266.19f, 223.0f, SPELL_SUMMON_ASSASSIN);
				break;

...
enum DataTypes
{
	...
	DATA_IS_LK_HEROIC_ENGAGEABLE       = 301,
};
...
enum CreaturesIds
{
	...
	// Deathbringer Saurfang Endevent
	// Horde
	NPC_CANDITH_THOMAS                          = 37935,
	NPC_MORGAN_TAGESGLANZ                       = 37936,
	NPC_WARSONG_PEON                            = 37930,
	// Alliance
	NPC_STORMWIND_PORTAL                        = 37880,
...
enum GameObjectsIds
{
	...
	// Deathbringer Saurfang endevent
	// Alliance stuff
	GO_ALLIANCE_ZEPPELIN_TRANSPORT = 201834,
	GO_ALLIANCE_TELEPORTER = 201858,
	GO_ALLIANCE_TENT = 201868,
	GO_ALLIANCE_BANNER = 201869,
	GO_ALLIANCE_BLACKSMITH_ANVIL = 1684,
	// Horde stuff
	GO_HORDE_TELEPORTER = 201880,
	GO_HORDE_BONFIRE = 187852,
	GO_HORDE_BLACKSMITH_ANVIL = 191345,
	GO_HORDE_TENT_1 = 201886,
	GO_HORDE_TENT_2 = 201887,
	// Alliance + Horde stuff
	GO_HORDE_ALLIANCE_FORGE = 1685,
...
enum SharedActions
{
	...
	// Saurfang end Event
	ACTION_START_HORDE_EVENT    = 1,
	ACTION_START_ALLIANCE_EVENT = 2,

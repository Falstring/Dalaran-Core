			...
			while (uint32 eventId = events.ExecuteEvent())
			{
				...
				case EVENT_END_POT:
					if (Unit* slagPotTarget = ObjectAccessor::GetUnit(*me, _slagPotGUID))
					{
						...
						slagPotTarget = NULL;
						_slagPotGUID = ObjectGuid::Empty; // CUIDADO CON ÉSTO.
...
public:
	...
	struct npc_iron_constructAI : public ScriptedAI
	{
			...
			void UpdateAI(uint32 /*uiDiff*/) override
		{
			...
			// COMPROBAR QUE SE QUITA EL STUN BRITTLE A LOS 20 SEGUNDOS, Y SI SE REVIENTA QUE HAGA DAÑO.

			/*



			PARA SPELLS COMO LOS SCORCH Y DEMÁS HACER un custom spell con el daño modificado en función a los stacks.

			Revisar unos que hiciste con damage, el daño modificado.

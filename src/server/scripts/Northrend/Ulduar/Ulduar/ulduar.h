...
enum UlduarNPCs
{
	...
	NPC_MOLGEIM = 32927,
	NPC_BRUNDIR = 32857,
	NPC_BRANN_BRONZBEARD_ASSEMBLY = 33235,
	NPC_PROSPECTOR_DOREN_ASSEMBLY = 33956,
	NPC_PROSPECTOR_LOREN_ASSEMBLY = 33957,
	NPC_KOLOGARN = 32930,
    ...
    NPC_ANCIENT_GATE_KEEPERS_VOICE = 381558,
};
...
enum UlduarGameObjects
{
	...
	GO_ANCIENT_GATEOFTHE_KEEPERS = 194255,
	...
	GO_MIMIRON_TRAIN_DOODAD_TURNAROUND01 = 194915,
	GO_MIMIRON_TRAIN_DOODAD_TURNAROUND02 = 194913,
...
enum LeviathanActions
{
	...
	ACTION_SAY_ULDUAR_DEFENSES = 11,
	ACTION_SAY_PRE_LEVIATHAN = 12,
	ACTION_SAY_EVASIVE_ACTION = 13,
};
...
enum UlduarData
{
	...
	DATA_MIMIRON_ENGAGED,

	DATA_MIMIRON_ACTIVATE_DOODAD_TURNAROUND,

	DATA_ANCIENT_GATEOFTHE_KEEPERS,

	// Observation Ring

	DATA_MIMIRON_OBSERVATION_RING,
	DATA_HODIR_OBSERVATION_RING,
	DATA_THORIM_OBSERVATION_RING,
	DATA_FREYA_OBSERVATION_RING,
};
...
enum UlduarEvents
{
	...
	EVENT_CHECK_ANCIENT_GATE = 7,

	EVENT_ACTIVATE_TRAIN_DOODAD_01 = 8,
	EVENT_ACTIVATE_TRAIN_DOODAD_02 = 9,

	EVENT_ACTIVATE_TRAIN_DOODAD_01_READY = 10,
	EVENT_ACTIVATE_TRAIN_DOODAD_02_READY = 11,

	EVENT_CHECK_KOLOGARN_DOOR = 12,

	EVENT_FLAME_LEVIATHAN_INTRO = 13,
	EVENT_FLAME_LEVIATHAN_INTRO_2 = 14,
	EVENT_FLAME_LEVIATHAN_INTRO_3 = 15,
	EVENT_FLAME_LEVIATHAN_INTRO_4 = 16,

	EVENT_KEEPER_IMAGES_CORRECTOR = 17,
};

...
const Position NecrolytePos1 = { 506.304f, 211.78f, 528.71f, float(M_PI) };
const Position NecrolytePos2 = { 506.127f, 231.46f, 528.71f, float(M_PI) };
...
const Position FBSSpawnPos = { 695.685f, -118.825f, 513.877f, 3 * float(M_PI) / 2 };

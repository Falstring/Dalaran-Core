	...
	struct boss_garfrostAI : public ScriptedAI
	{
		...
		void DamageTaken(Unit*, uint32& /*damage*/)
		{
			if (phase == 0 && !HealthAbovePct(66) && !me->HasUnitState(UNIT_STATE_ROOT))
			{
				...
				events.RescheduleEvent(EVENT_GAR_JUMP, 1250);
				return;
			}
		...
		void UpdateAI(uint32 diff)
		{
			...
			case EVENT_SPELL_THROW_SARONITE:
				...
				events.RescheduleEvent(EVENT_SPELL_THROW_SARONITE, urand(12500, 20000));
				break;
			case EVENT_GAR_JUMP:
			...
			case EVENT_SPELL_CHILLING_WAVE:
				...
				events.RescheduleEvent(EVENT_SPELL_CHILLING_WAVE, (35000));
				break;
			case EVENT_SPELL_DEEP_FREEZE:
				...
				events.RescheduleEvent(EVENT_SPELL_DEEP_FREEZE, (35000));
				break;
			}

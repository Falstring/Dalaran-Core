	...
	struct boss_bronjahmAI : public ScriptedAI
	{
		...
		void UpdateAI(uint32 diff)
		{
			...
			case EVENT_SPELL_FEAR:
				...
				events.RescheduleEvent(EVENT_SPELL_FEAR, urand(8000, 12000));
				break;
			case EVENT_SPELL_MAGICS_BANE:
				me->CastSpell(me->GetVictim(), SPELL_MAGICS_BANE, false);
				events.RescheduleEvent(EVENT_SPELL_MAGICS_BANE, urand(10000, 15000));
				break;
			case EVENT_SPELL_CORRUPT_SOUL:
				...
				events.RescheduleEvent(EVENT_SPELL_CORRUPT_SOUL, urand(20000, 25000));
				break;

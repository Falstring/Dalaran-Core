		...
		bool CheckAchievementCriteriaMeet(uint32 criteria_id, Player const* source, Unit const* target = NULL, uint32 miscvalue1 = 0)
		{
			...
			case 12752: // Soul Power
				if (Creature* c = instance->GetCreature(NPC_BronjahmGUID))
				{
					...
					Trinity::AllCreaturesOfEntryInRange checker(c, 36535, 200.0f);
					Trinity::CreatureListSearcher<Trinity::AllCreaturesOfEntryInRange> searcher(c, L, checker);

					c->VisitNearbyObject(200.0f, searcher);

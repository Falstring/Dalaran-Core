	...
	struct boss_devourer_of_soulsAI : public ScriptedAI
	{
		...
		void UpdateAI(uint32 diff)
		{
			...
			if (Spell* s = me->GetCurrentSpell(CURRENT_CHANNELED_SPELL))
				if (s->m_spellInfo->Id == SPELL_MIRRORED_SOUL)
				{
					...
					case EVENT_SPELL_MIRRORED_SOUL:
						//events.RescheduleEvent(EVENT_SPELL_MIRRORED_SOUL, urand(9000, 11000));
						break;
					case EVENT_SPELL_WELL_OF_SOULS:
						events.RescheduleEvent(EVENT_SPELL_WELL_OF_SOULS, urand(10500, 12000));
						break;
					case EVENT_SPELL_UNLEASHED_SOULS:
						events.RescheduleEvent(EVENT_SPELL_UNLEASHED_SOULS, urand(10000, 11000));
						break;
					case EVENT_SPELL_WAILING_SOULS:
						events.RescheduleEvent(EVENT_SPELL_WAILING_SOULS, 9000);
						break;
					default:
						events.RescheduleEvent(EVENT_SPELL_PHANTOM_BLAST, 1000);
						break;
					}
			...
			case EVENT_SPELL_MIRRORED_SOUL:
				...
				events.RescheduleEvent(EVENT_SPELL_MIRRORED_SOUL, urand(20000, 30000));
				break;
			case EVENT_SPELL_WELL_OF_SOULS:
				if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 40.0f, true))
					me->CastSpell(target, SPELL_WELL_OF_SOULS, false);
				events.RescheduleEvent(EVENT_SPELL_WELL_OF_SOULS, urand(25000, 30000));
			...
			case EVENT_SPELL_UNLEASHED_SOULS:
				...
				events.RescheduleEvent(EVENT_SPELL_UNLEASHED_SOULS, urand(30000, 40000));
			...
			case EVENT_SPELL_WAILING_SOULS:
				...
				events.RescheduleEvent(EVENT_SPELL_WAILING_SOULS, 80000);

...
void Vehicle::ApplyAllImmunities()
{
    ...
    switch (GetVehicleInfo()->m_ID)
    {
        ...
        case 543: // Isle of Conquest
            ...
            break;
        case 158: // Strand of Ancients Battleground Demolishers, immune against Aspect of the Pack
            _me->ApplySpellImmune(0, IMMUNITY_ID, 13159, true);            
            break;
        default:
            break;
    }

...
#define INTERACTION_DISTANCE_GO     5.2f
...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        uint32 GetLastSummonTime() const { return m_lastSummonTimer; }
        void SetLastSummonTime(uint32 time) { m_lastSummonTimer = time; }

		uint32 GetTempSummonCount(uint8 type) const { return type == 0 ? m_tempSummonCount : m_tempTotalSummonCount; }
		void IncrTempTotalSummonCount() { ++m_tempTotalSummonCount; }
        void IncrTempSummonCount() { ++m_tempSummonCount; }
        void ResetTempSummonCount() { m_tempSummonCount = 0; }
		void ResetTempTotalSummonCount() { m_tempTotalSummonCount = 0; }
    ...
    private:
        ...
        uint32 m_lastSummonTimer;
        uint32 m_tempSummonCount = 0;
        uint32 m_tempTotalSummonCount = 0;

...
void Pet::AddToWorld()
{
    ...
    if (ObjectAccessor::FindPlayer(GetOwnerGUID()) && GetMapId() == 631 && FindMap() && FindMap()->ToInstanceMap() && FindMap()->ToInstanceMap()->GetInstanceScript() && FindMap()->ToInstanceMap()->GetInstanceScript()->GetData(251 /*DATA_BUFF_AVAILABLE*/))
...
bool Guardian::InitStatsForLevel(uint8 petlevel)
{
    ...
    if (cFamily && cFamily->minScale > 0.0f && petType == HUNTER_PET)
    {
        ...
        case CREATURE_FAMILY_DEVILSAUR:
            scale = 0.9f + float(getLevel() / 100.0f);
            SetObjectScale(scale);
            SetFloatValue(UNIT_FIELD_COMBATREACH, 4);
            SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, 5);
            break;
        case CREATURE_FAMILY_CHIMAERA:
        case CREATURE_FAMILY_CORE_HOUND:
        case CREATURE_FAMILY_RHINO:
            scale = 1.2f + float(getLevel() / 100.0f);
            SetObjectScale(scale);
            SetFloatValue(UNIT_FIELD_COMBATREACH, 4);
            SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, 5);
            break;
        default:
            scale = 0.6f + float(getLevel() / 100.0f);
            SetObjectScale(scale);
            SetFloatValue(UNIT_FIELD_COMBATREACH, 3);
            SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, 3);
            break;
        }
    }
    ...
    case SUMMON_PET:
    {
        ...
        case NPC_FELGUARD:
        {
            ...
            // Gylph of Felguard
            if (m_owner->HasAura(56246))
                SetModifierValue(UNIT_MOD_ATTACK_POWER, TOTAL_PCT, 1.0f + float(20.0f / 100.0f));
        ...
        case NPC_WATER_ELEMENTAL_PERM:
        {
            ...
            AddAura(61017, this); //
            AddAura(35657, this); // SPELL_MAGE_PET_SCALING_01
            AddAura(35658, this); // SPELL_MAGE_PET_SCALING_02
            AddAura(35659, this); // SPELL_MAGE_PET_SCALING_03
            AddAura(35660, this); // SPELL_MAGE_PET_SCALING_04
    ...
    default:
    {
        ...
        case NPC_FIRE_ELEMENTAL:
        {
            ...
            AddAura(32233, this); // SPELL_PET_AVOIDANCE
            AddAura(61017, this); //
            AddAura(35665, this); // SPELL_SHAMAN_FIRE_ELEMENTAL_PET_SCALING_01
            AddAura(35666, this); // SPELL_SHAMAN_FIRE_ELEMENTAL_PET_SCALING_02
            AddAura(35667, this); // SPELL_SHAMAN_FIRE_ELEMENTAL_PET_SCALING_03
            AddAura(35668, this); // SPELL_SHAMAN_FIRE_ELEMENTAL_PET_SCALING_04
            break;
        }
        case NPC_EARTH_ELEMENTAL:
        {
            ...
            AddAura(32233, this); // SPELL_PET_AVOIDANCE
            AddAura(61017, this); //
            AddAura(65225, this); // SPELL_SHAMAN_EARTH_ELEMENTAL_PET_SCALING_01
            AddAura(65226, this); // SPELL_SHAMAN_EARTH_ELEMENTAL_PET_SCALING_02
            AddAura(65227, this); // SPELL_SHAMAN_EARTH_ELEMENTAL_PET_SCALING_03
            AddAura(65228, this); // SPELL_SHAMAN_EARTH_ELEMENTAL_PET_SCALING_04
            break;
        }
        case NPC_INFERNAL:
        {
            ...
            AddAura(32233, this); // SPELL_PET_AVOIDANCE
            AddAura(34947, this); // SPELL_WARLOCK_PET_SCALING_01
            AddAura(34956, this); // SPELL_WARLOCK_PET_SCALING_02
            AddAura(34957, this); // SPELL_WARLOCK_PET_SCALING_03
            AddAura(34958, this); // SPELL_WARLOCK_PET_SCALING_04
            AddAura(61013, this); // SPELL_WARLOCK_PET_SCALING_05
            break;
        }
        case NPC_DOOMGUARD:
        {
        ...
        case NPC_TREANT: //force of nature
        {
            ...
            AddAura(32233, this); // SPELL_PET_AVOIDANCE
            AddAura(61017, this); //
            AddAura(35669, this); // SPELL_DRUID_PET_SCALING_01
            AddAura(35670, this); // SPELL_DRUID_PET_SCALING_02
            AddAura(35671, this); // SPELL_DRUID_PET_SCALING_03
            AddAura(35672, this); // SPELL_DRUID_PET_SCALING_04
            break;
        }
        ...
        case NPC_FERAL_SPIRIT:
        {
            ...
            AddAura(32233, this); // SPELL_PET_AVOIDANCE
            AddAura(58877, this); // Spirit Hunt
            AddAura(35674, this); // SPELL_SHAMAN_FERAL_SPIRIT_PET_SCALING_01
            AddAura(35675, this); // SPELL_SHAMAN_FERAL_SPIRIT_PET_SCALING_02
            AddAura(35676, this); // SPELL_SHAMAN_FERAL_SPIRIT_PET_SCALING_03
            AddAura(35677, this); // SPELL_SHAMAN_FERAL_SPIRIT_PET_SCALING_04
            break;
        }
        ...
        case NPC_EBON_GARGOYLE: // Ebon Gargoyle
        {
            ...
            AddAura(61017, this); //
            AddAura(51996, this); // SPELL_DK_PET_SCALING_01
            AddAura(54566, this); // SPELL_DK_PET_SCALING_02
            AddAura(61697, this); // SPELL_DK_PET_SCALING_03
            break;
        }
        case NPC_BLOODWORM:
        {
    ...
    if (GetEntry() == NPC_RISEN_GHOUL)
    {
        if (m_owner->getRace() == RACE_ORC)
            CastSpell(this, 65221, true, nullptr, nullptr, m_owner->GetGUID());

        // Night of the Dead
        if (Aura *aur = AddAura(62137, this))
...
void Pet::_SaveAuras(SQLTransaction& trans)
{
    ...
    for (AuraMap::const_iterator itr = m_ownedAuras.begin(); itr != m_ownedAuras.end(); ++itr)
    {
        ...
        // Don't save auras that cannot be cancelled (needed for ICC buff on pets/summons)
        ...
        // Don't save auras with model change
        if (aura->GetSpellInfo()->HasAura(SPELL_AURA_TRANSFORM))
            continue;

        // Don't save auras with interrupt flags on map change

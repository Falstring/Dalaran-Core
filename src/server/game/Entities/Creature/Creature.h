...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_NO_CREATURE_DAMAGE  = 0x00000400,       // creature is immune to damage from creatures with this flag
    ...
    CREATURE_FLAG_EXTRA_DAMAGE_LIKE_PLAYER  = 0x40000000,       // creature damage is dealed like player damage
};
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_IGNORE_PATHFINDING | CREATURE_FLAG_EXTRA_DAMAGE_LIKE_PLAYER | \
...
class Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool HasFlagExtra(uint32 flag) const { return (GetCreatureTemplate()->flags_extra & flag) != 0; }

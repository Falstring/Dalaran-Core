...
#define AVERAGE_UPDATE_DIFF_COUNT 1000
...
enum WorldBoolConfigs
{
	...
	CONIFG_AVERAGE_UPDATE_DIFF_ENABLED,
	CONFIG_DYNAMIC_VISIBILITY_DISTANCE_ENABLED,
...
class World
{
    public:
		...
		/// Average Update time
		uint32 GetAverageUpdateTime() const { return m_lastAverageUpdateTime; }
    ...
    private:
		...
		uint32 m_averageUpdateTime;
		uint32 m_lastAverageUpdateTime;
		uint32 m_averageUpdateTimeContainer[AVERAGE_UPDATE_DIFF_COUNT];
		uint32 m_averageUpdateTimeIndex;
		uint32 m_averageUpdateTimeTotal;

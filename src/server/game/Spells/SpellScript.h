...
enum AuraScriptHookType
{
    ...
    AURA_SCRIPT_HOOK_STEAL,
    AURA_SCRIPT_HOOK_AFTER_STEAL,
    // Spell Proc Hooks
...
class AuraScript : public _SpellScript
{
    ...
    #define AURASCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
        ...
        typedef void(CLASSNAME::*AuraStealFnType)(StealInfo* stealInfo); \
        ...
        class AuraStealHandler
        {
            public:
                AuraStealHandler(AuraStealFnType pHandlerScript);
                void Call(AuraScript* auraScript, StealInfo* stealInfo);
            private:
                AuraStealFnType pHandlerScript;
        };
        ...
        class AuraStealFunction : public AuraScript::AuraStealHandler { public: AuraStealFunction(AuraStealFnType _pHandlerScript) : AuraScript::AuraStealHandler((AuraScript::AuraStealFnType)_pHandlerScript) { } }; \
    ...
    public:
        ...
        // executed when aura is stolen by a unit
        // example: OnSteal += AuraStealFn(class::function);
        // where function is: void function;
        HookList<AuraStealHandler> OnSteal;
        // executed after aura is stolen by a unit
        // example: AfterSteal += AuraStealFn(class::function);
        // where function is: void function (StealInfo* stealInfo);
        HookList<AuraStealHandler> AfterSteal;
        #define AuraStealFn(F) AuraStealFunction(&F)
        ...
        // stolen - aura stolen by SPELL_EFFECT_STEAL_BENEFICIAL_BUFF
        bool IsStolen() const;

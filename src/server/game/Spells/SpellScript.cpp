...
AuraScript::AuraStealHandler::AuraStealHandler(AuraStealFnType _pHandlerScript)
{
    pHandlerScript = _pHandlerScript;
}

void AuraScript::AuraStealHandler::Call(AuraScript* auraScript, StealInfo* _stealInfo)
{
    (auraScript->*pHandlerScript)(_stealInfo);
}
...
bool AuraScript::IsStolen() const
{
    return m_aura->IsStolen();
}

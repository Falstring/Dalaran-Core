...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_FORCE_PREVENTED_REASON        = 0x00080000,  // Implemented in Spell::CheckCasterAuras() Force prevented reason even if spell cast grant immunity for SPELL_ATTR0_CU_FORCE_PREVENTED_REASON
    SPELL_ATTR0_CU_UNLEARN_PREVIOUS_SPELL        = 0x00100000,
    SPELL_ATTR0_CU_SAME_STACK                    = 0x00200000,
    SPELL_ATTR0_CU_FORCE_REFLECT                 = 0x00400000,
    SPELL_ATTR0_CU_NO_POSITIVE_TAKEN_BONUS       = 0x00800000,

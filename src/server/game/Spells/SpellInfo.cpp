...
bool SpellEffectInfo::IsFarUnitTargetEffect() const
{
    return (Effect == SPELL_EFFECT_SUMMON_PLAYER)
        ...
        /*|| (Effect == SPELL_EFFECT_SKIN_PLAYER_CORPSE)*/; // optimization
}
...
bool SpellEffectInfo::IsEffectAbleToCrit() const
{
    if (_spellInfo->HasAttribute(SPELL_ATTR2_CANT_CRIT))
        return false;
    ...
    switch (Effect)
    {
        ...
        case SPELL_EFFECT_ENERGIZE:
            return (_spellInfo->SpellFamilyName && _spellInfo->DmgClass);
    }
        ...
        case SPELLFAMILY_GENERIC:
        {
            ...
            else
            {
                ...
                switch (Id)
                {
                    ...
                    case 57521:
                    case 57522:
                    case 57514: // Enrage (Improved Defensive Stance)
                    case 57516:
...
bool SpellInfo::IsSpellAbleToCrit() const
{
    if (HasAttribute(SPELL_ATTR2_CANT_CRIT))
        return false;

    for (uint8 i = 0; i < MAX_SPELL_EFFECTS; ++i)
    {
        if (Effects[i].IsEffectAbleToCrit())
            return true;
    }

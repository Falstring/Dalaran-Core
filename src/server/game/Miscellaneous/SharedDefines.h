...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_SUSPEND_ATTACK_TIMER             = 0x00000020, //  5
    ...
    SPELL_ATTR6_NOT_RESET_SWING_IF_INSTANT       = 0x02000000, // 25 Exorcism, Flash of Light (don't reset timers for melee autoattacks (swings) or ranged autoattacks (autoshoots))

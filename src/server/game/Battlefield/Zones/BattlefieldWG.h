...
class BattlefieldWG : public Battlefield
{
    public:
        ...
        void CreateCapturePoint(GameObject* go, WintergraspWorkshop* workshop, TeamId teamControl);
        ...
        ObjectGuid GetBannerData(uint32 data);
        void SpawnBanners();
        void CastRewardSpell(Player* player, uint32 spellEntry, uint32 amount);
    ...
    protected:
        ...
        ObjectGuid m_workshopBannerNEGUID;
        ObjectGuid m_workshopBannerNWGUID;
        ObjectGuid m_workshopBannerSEGUID;
        ObjectGuid m_workshopBannerSWGUID;
};
...
public:
    ...
    void LinkWorkshopData(uint32 bannerData, TeamId team);

...
enum SMART_ACTION
{
    ...
    // Costum SAI Actions - Continue merging and rechecking this!
    SMART_ACTION_SET_RESPAWN_TIME                   = 200,     // timer
    SMART_ACTION_MOVE_HOME_POS                      = 201,     // No Params
    SMART_ACTION_REMOVE_EVADE                       = 202,     // No Params
    SMART_ACTION_SET_COMBAT_DISTANCE                = 203,     // combatDistance

    SMART_ACTION_END                                = 300
};

...
#define ARENA_TEAM_CREATE_LEVEL_REQUIREMENT 70
...
void WorldSession::HandlePetitionBuyOpcode(WorldPacket& recvData)
{
    ...
    else
    {
        ...
        if (_player->getLevel() < ARENA_TEAM_CREATE_LEVEL_REQUIREMENT)
        {
            SendNotification(LANG_ARENA_ONE_TOOLOW, ARENA_TEAM_CREATE_LEVEL_REQUIREMENT);
            return;
        }

...
void WorldSession::HandleMessagechatOpcode(WorldPacket& recvData)
{
    ...
    switch (type)
    {
        ...
        case CHAT_MSG_YELL:
        {
			...
			// Playtime requirements, 4 hours.
			if (!sender->IsGameMaster() && sender->GetTotalPlayedTime() <= 14400 && sender->getLevel()<70)
			{
				SendNotification("You must have at least 4 hours of played time with this character before being able to chat.");
				return;
			}
